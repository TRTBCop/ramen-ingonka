  ...
  <AdminLayout>
    ...
    <div class="flex-column-fluid card mt-5 p-9">
      <Training1Navbar>
        <QuestionsTable
          :questions="questions"
          :question-options="training1TextSummarizationOptions"
    ...
    <div class="d-flex gap-3">
      ...
      <el-form-item class="mb-0 mt-5" label="검수 여부">
        <el-switch v-model="isPublished" @change="updateSummarizationData" />
      </el-form-item>
    </div>
  </AdminLayout>
</template>
...
<script setup lang="ts">
  ...
  import { training1TextSummarizationOptions } from './trainingQuestionOptions';
  ...
  const previewUrl = computed(() =>
    route('app.trainings.stage1.texts.summarizations.preview.show', {
  ...
  function updateSummarizationData() {
    if (!pageData.props.contents) {
      pageData.props.contents = {
        questions: [],
      };
    ...
    router.put(
      ...
      {
        summarizations: pageData.props.contents as any,
      },
    );
  }
