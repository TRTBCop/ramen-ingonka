<template>
  <div class="table-responsive">
    ...
    >
      ...
      <template v-else>
        <tr class="odd">
          <td :colspan="header.length + 1" class="dataTables_empty text-center text-gray-400">
            {{ emptyTableText }}
          </td>
        </tr>
      </template>
...
<script lang="ts">
  ...
  import TableHeadRow from '@/admin/components/kt-datatable/table-partials/table-content/table-head/TableHeadRow.vue';
  import TableBodyRow from '@/admin/components/kt-datatable/table-partials/table-content/table-body/TableBodyRow.vue';
  import Loading from '@/admin/components/kt-datatable/table-partials/Loading.vue';
  ...
  export default defineComponent({
    ...
    props: {
      ...
      emptyTableText: { type: String, default: '데이터가 없습니다' },
