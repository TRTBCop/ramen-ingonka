    ...
    <div class="card-body d-flex flex-column">
      ...
      <div class="pt-5">
        <p class="text-center fs-6 pb-5">
          <span class="badge badge-light-danger fs-8">Notes:</span>&nbsp; Current sprint requires stakeholders<br />
...
<script lang="ts">
  ...
  import Dropdown1 from '@/admin/components/dropdown/Dropdown1.vue';
  ...
  const chartOptions = (color = 'primary', height = 'auto'): ApexOptions => {
