...
<script setup lang="ts">
  ...
  import type {
    ...
    IStep3,
    IStep4,
  } from '@/admin/components/modals/wizards/create-app-modal/types';
  import CreateAppStep1 from '@/admin/components/modals/wizards/create-app-modal/steps/CreateAppStep1.vue';
  import CreateAppStep2 from '@/admin/components/modals/wizards/create-app-modal/steps/CreateAppStep2.vue';
  import CreateAppStep3 from '@/admin/components/modals/wizards/create-app-modal/steps/CreateAppStep3.vue';
  import CreateAppStep4 from '@/admin/components/modals/wizards/create-app-modal/steps/CreateAppStep4.vue';
  import CreateAppStep5 from '@/admin/components/modals/wizards/create-app-modal/steps/CreateAppStep5.vue';
