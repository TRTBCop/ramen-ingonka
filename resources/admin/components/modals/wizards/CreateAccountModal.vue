<template>
  ...
  <div id="kt_modal_create_account" ref="createAccountModalRef" class="modal fade" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog mw-1000px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y m-5">
          <!--begin::Stepper-->
          <div id="kt_create_account_stepper" ref="createAccountRef" class="stepper stepper-links d-flex flex-column">
            <!--begin::Nav-->
            ...
            <!--begin::Form-->
            <form id="kt_create_account_form" class="mx-auto mw-600px w-100 py-10" novalidate @submit="handleStep">
              <!--begin::Step 1-->
...
<script lang="ts">
  ...
  import { hideModal } from '@/admin/core/helpers/dom';
