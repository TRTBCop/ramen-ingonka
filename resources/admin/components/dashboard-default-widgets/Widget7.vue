  ...
  <div class="card card-flush" :class="className">
    ...
    <div class="card-body pt-6">
      ...
      <div class="tab-content">
        <template v-for="(item, i) in items" :key="i">
          <!--begin::Tap pane-->
          <div :id="`kt_stats_widget_16_tab_${i}`" class="tab-pane fade" :class="[i === 0 && 'active show']">
...
<script lang="ts">
  ...
  import Dropdown2 from '@/admin/components/dropdown/Dropdown2.vue';

  export default defineComponent({
    name: 'DefaultDashboardWidget7',
    components: {
      Dropdown2,
    },
    props: {
