  ...
  <div class="card card-flush" :class="className">
    ...
    <div class="card-header pt-5">
      ...
      <div class="card-toolbar">
        <ul id="kt_chart_widget_8_tabs" class="nav">
          <li class="nav-item">
            <a
    ...
    <div class="card-body pt-6">
      ...
      <div class="tab-content">
        <!--begin::Tab pane-->
        <div id="kt_chart_widget_8_week_tab" class="tab-pane fade" role="tabpanel">
          <!--begin::Statistics-->
          <div class="mb-5">
            <!--begin::Statistics-->
        ...
        <!--begin::Tab pane-->
        <div id="kt_chart_widget_8_month_tab" class="tab-pane fade active show" role="tabpanel">
          <!--begin::Statistics-->
          <div class="mb-5">
            <!--begin::Statistics-->
            <div class="d-flex align-items-center mb-2">
