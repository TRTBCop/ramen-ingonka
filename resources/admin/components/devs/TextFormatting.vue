<template>
  ...
  <div id="kt_devs_ask_formatting" class="collapse">
    ...
    <ul class="list-unstyled p-0 mb-10">
      ...
      <li class="py-1 fs-6"> <img alt="happy" :src="getAssetPath('media/smiles/happy.png')" />&nbsp;&nbsp;:) </li>
      <li class="py-1 fs-6"> <img alt="shocked" :src="getAssetPath('media/smiles/shocked.png')" />&nbsp;&nbsp;:| </li>
      <li class="py-1 fs-6"> <img alt="sad" :src="getAssetPath('media/smiles/sad.png')" />&nbsp;&nbsp;:( </li>
    </ul>
  </div>
  <!--end::Formating info-->
</template>
