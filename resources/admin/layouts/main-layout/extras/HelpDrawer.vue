<template>
  ...
  >
    ...
    <div class="card shadow-none rounded-0 w-100">
      <!--begin::Header-->
      <div id="kt_help_header" class="card-header">
        <h5 class="card-title fw-semobold text-gray-600"> Learn & Get Inspired </h5>

        <div class="card-toolbar">
          <button id="kt_help_close" type="button" class="btn btn-sm btn-icon explore-btn-dismiss me-n5">
      ...
      <!--begin::Body-->
      <div id="kt_help_body" class="card-body">
        <!--begin::Content-->
        <div
          id="kt_help_scroll"
          ...
          <div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
            ...
            <div class="fs-5 fw-semobold mb-5">
              <span class="text-gray-500"
                >Join our developers community to find answer to your question and help others.</span
              >
