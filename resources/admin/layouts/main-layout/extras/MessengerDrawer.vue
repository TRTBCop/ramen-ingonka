...
<script lang="ts">
  ...
  import MessageIn from '@/admin/components/messenger-parts/MessageIn.vue';
  import MessageOut from '@/admin/components/messenger-parts/MessageOut.vue';
  import Dropdown4 from '@/admin/components/dropdown/Dropdown4.vue';
