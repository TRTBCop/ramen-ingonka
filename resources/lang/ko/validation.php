...
return [
    ...
    */
    ...
    'enum' => ':attribute이 유효한 값이 아닙니다.',
    'strict_integer' => ':attribute은(는) 정수어야 합니다.',
    'strict_string' => ':attribute은(는) 문자열이어야 합니다.',
    ...
    */
    ...
    'attributes' => [
        ...
        'options' => '보기',
        'answers.*.type' => '답안타입',
        'answers.*.action' => '답안행동영역',
        'answers.*.answer.*' => '답안정답',
        'answers.*.choice_symbol' => '답안심볼유무',
        'answers.*.choices' => '답안선지',
    ],
];
